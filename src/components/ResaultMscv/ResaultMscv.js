...
import gus_kus from "../../assets/images/mackwa_gus.svg";
import gus_kus2 from "../../assets/images/mackwa_gus2.svg";
      ...
      <div className="choose">
         ...
         <div className="choose__page-resault-card">
            <div className="choose__page-resault-card">
               ...
               <img src={gus_kus} className="choose__page-resault-card-img2" alt="logo" />
