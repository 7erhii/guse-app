      ...
      <div className="screen">
         <div className="screen-load">
            <div className="screen-load__content">
               <p className="screen-load__content-title"> Бойовий гусак із біолабораторій України готовий нанести «свєрх-трататата» по ворожим об’єктам </p>
               <div className="screen-load__content-img">
                  ...
                  <img src={background} className="screen-load__content-img-background" alt="logo" />
               </div>
               

                <button className="screen-load__switch themetoggle"></button>
               <Link to={'/ChoosePage'} className="screen-load__content-btn" ><button > Обрати позицію </button></Link>
            </div>
         </div>
      </div>
            ...
            <div className="screen-load">
               <div className="screen-load__content">
                  ...
                  <div className="screen-load__content-img">
                   ...
                   <input className="screen-load__switch themetoggle" type={'checkbox'}></input>
